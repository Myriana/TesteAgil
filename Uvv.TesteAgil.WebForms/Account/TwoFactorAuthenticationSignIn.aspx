<%@ Page Title="Autenticação de dois fatores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="Uvv.TesteAgil.WebForms.Account.TwoFactorAuthenticationSignIn" %>
