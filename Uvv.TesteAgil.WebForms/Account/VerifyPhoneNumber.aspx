<%@ Page Title="Verificar número de telefone" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="Uvv.TesteAgil.WebForms.Account.VerifyPhoneNumber" %>
