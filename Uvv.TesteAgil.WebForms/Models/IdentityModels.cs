...
namespace Uvv.TesteAgil.WebForms.Models
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        public ClaimsIdentity GenerateUserIdentity(ApplicationUserManager manager)
        {
            ...
            userIdentity.AddClaim(new Claim("nmeUsuario", this.Nome));
            userIdentity.AddClaim(new Claim("nmeEmail", this.Email));
            userIdentity.AddClaim(new Claim("nmeLogin", this.Email));
            userIdentity.AddClaim(new Claim("numId", this.MembroId.ToString()));
            return userIdentity;
        }
